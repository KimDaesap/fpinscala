...
val name = Either.mkName("")
val age = Either.mkAge(-1)

List(name, age).filter(_.isInstanceOf[Left[String]])

Either.mkPerson1("Kim daesap", 10)
Either.mkPerson1("Kim daesap", -1)
Either.mkPerson1("", 10)
Either.mkPerson1("", -1)
